...
class Locators:
    ...
    REGISTRATION_BUTTON_ON_LOGIN_PAGE = \
        (By.XPATH,
         "//*[contains(@class, 'Auth_link') and text()='Зарегистрироваться']")  # кнопка "Зарегистрироваться" на странице входа
    ...
    REGISTRATION_BUTTON_ON_REG_PAGE = \
        (By.XPATH,
         "//*[contains(@class, 'button_button') and text()='Зарегистрироваться']")  # кнопка "Зарегистрироваться" на странице регистрации
    ...
    BUNS_LIST = (By.XPATH, "//ul[@class='BurgerIngredients_ingredients__list__2A-mT']/preceding-sibling::h2[contains(text(), 'Булки')]")  # Список булок
    SAUCES_LIST = (By.XPATH, "//ul[@class='BurgerIngredients_ingredients__list__2A-mT']/preceding-sibling::h2[contains(text(), 'Соусы')]")  # Список соусов
    TOPPINGS_LIST = (By.XPATH, "//ul[@class='BurgerIngredients_ingredients__list__2A-mT']/preceding-sibling::h2[contains(text(), 'Начинки')]")  # Список начинок
    BURGER_INGREDIENTS_CONTAINER = \
        (By.XPATH,
         "//*[contains(@class, 'BurgerIngredients_ingredients__menuContainer')]")  # Локатор ингредиентов бургера
